              ...
              <div className={styles.dataBlock}>
                <div className={styles.formBlock}>
                  ...
                  <div className={styles.input_container}>
                    ...
                    <textarea value={nickname !== "" && courseId !== 0 && lessonProgramId !== 0 ? "oilan.io/cabinet/student/" + nickname + "/course/" + courseUrl + "?program=" + lessonProgramId : "Ссылка будет создана после указания всех полей"}
                    />
                  </div>
                  <span
