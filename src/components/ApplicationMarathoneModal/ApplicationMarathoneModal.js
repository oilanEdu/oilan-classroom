...
import styles from "./ApplicationMarathoneModal.module.css";
...
const ApplicationMarathoneModal = ({showSend, handleShowSend, onClose}) => {
  ...
  return <>
    ...
    >
      ...
      <div className={styles.modal_info}>
        <h3>Оставь заявку для записи на Новогодний марафон </h3>
      </div>
...
export default ApplicationMarathoneModal;