...
import AnswersHomeWorksOfTeacherComponent from "../AnswersHomeWorksOfTeacherComponent/AnswersHomeWorksOfTeacherComponent";
...
function HomeworksByTeacher(props) {
  ...
  const loadBaseData = async () => {
    ...
    const uniqueLessonsOfStudent = uniqueLessons.filter(el => el.student_id === props.student.id)
    setAnswers(uniqueLessonsOfStudent)
